...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost/holcroft/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// JS Vendor options.
	jsVendorSRC: './assets/js/bootstrap/*.js', // Path to JS vendor folder.
	jsVendorDestination: './assets/js/', // Path to place the compiled JS vendors file.
	jsVendorFile: 'bootstrap', // Compiled JS vendors file name. Default set to vendors i.e. vendors.js.
